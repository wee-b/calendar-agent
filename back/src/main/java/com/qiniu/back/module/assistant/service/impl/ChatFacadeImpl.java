...
public class ChatFacadeImpl implements ChatFacade {
    ...
    @Autowired
    private com.qiniu.back.module.assistant.service.ChatService assistantChatService;
    ...
    public ChatResponseVO chat(String sessionId, String message) {
        ...
        ChatDispatchResult result = assistantChatService.process(userId, sid, message, userDialogueId);
