...
public class ResponseDTO<T> {
    ...
    public static <T> ResponseDTO<T> userErrorParam() {
        return new ResponseDTO<>(ErrorCode.BAD_REQUEST, false, null, null);
    }

    public static <T> ResponseDTO<T> userErrorParam(String msg) {
        return new ResponseDTO<>(ErrorCode.BAD_REQUEST, false, msg, null);
    }
    ...
    public static <T> ResponseDTO<T> error(ResponseDTO<?> responseDTO) {
        return new ResponseDTO<>(responseDTO.getCode(), responseDTO.getLevel(), responseDTO.getOk(),
                responseDTO.getMsg(), null);
    }
